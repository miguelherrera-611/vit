...
const STYLES = `
    ...
    *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
    ...
    .glass-input { width:100%; padding:0.78rem 0.95rem; background:rgba(255,255,255,0.55); border:1px solid rgba(200,140,80,0.22); border-radius:10px; font-size:0.88rem; color:#2d1a08; font-family:'Inter',sans-serif; outline:none; transition:all 0.18s; box-shadow:inset 0 1px 0 rgba(255,255,255,0.8); }
    .glass-input::placeholder { color:rgba(180,100,30,0.35); }
    .glass-input:focus { background:rgba(255,255,255,0.72); border-color:rgba(200,140,80,0.45); box-shadow:0 0 0 3px rgba(185,28,28,0.05),inset 0 1px 0 rgba(255,255,255,0.9); }
    .field-error { margin-top:0.3rem; font-size:0.72rem; color:rgba(185,28,28,0.85); font-weight:500; }
    .glass-btn { width:100%; padding:0.78rem; border-radius:10px; font-family:'Inter',sans-serif; font-size:0.88rem; font-weight:500; letter-spacing:-0.01em; cursor:pointer; transition:all 0.2s; background:rgba(185,28,28,0.08); color:rgba(185,28,28,0.92); border:1px solid rgba(185,28,28,0.22); box-shadow:0 2px 10px rgba(185,28,28,0.08); }
...
export default function ResetPassword({ token, email }) {
    ...
    return (
        <>
            <Head title="Nueva contraseña — VitaliStore" />
            <style>{STYLES}</style>
            <div className="auth-bg">
                ...
                <div className="auth-wrap">
                    <div className="logo-area">
                        ...
                        <span className="logo-sub">Nueva contraseña</span>
                    </div>

                    <div className="glass-card">
                        <h1 className="card-title">Restablecer contraseña</h1>
                        <p className="card-sub">Elige una contraseña segura para tu cuenta.</p>
                        ...
                        <form onSubmit={submit}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="password" className="glass-input" placeholder="Mínimo 8 caracteres"
                            ...
                            <div className="form-group" style={{marginBottom:'1.25rem'}}>
                                ...
                                <input type="password" className="glass-input" placeholder="Repite tu contraseña"
