...
export default function ConfirmPassword() {
    ...
    const submit = (e) => { e.preventDefault(); post('/confirm-password'); };

    return (
        <>
            <Head title="Confirmar contraseña — VitaliStore" />
            <style>{STYLES}</style>
            <div className="auth-bg">
                ...
                <div className="auth-wrap">
                    <div className="logo-area">
                        ...
                        <span className="logo-sub">Zona segura</span>
                    </div>

                    <div className="glass-card">
                        <h1 className="card-title">Confirmar contraseña</h1>
