            ...
            <div className="auth-bg">
                <div className="auth-card">
                    <div className="logo-wrap">
                        ...
                        <p className="logo-sub">Zona segura</p>
                    </div>
                    <p className="form-heading">Confirmar Contraseña</p>
                    <p className="form-desc">Por seguridad, confirma tu contraseña antes de continuar.</p>
