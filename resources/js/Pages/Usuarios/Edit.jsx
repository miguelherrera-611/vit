...
export default function UsuariosEdit({ usuario, permisos_disponibles }) {
                ...
                <div className="bg-white border-b border-gray-200">
                    <div className="max-w-4xl mx-auto px-6 py-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-light text-gray-900">Editar Usuario</h1>
                                <p className="mt-1 text-sm text-gray-500">{usuario.name} · {usuario.email}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Nueva contraseña <span className="text-gray-400 font-normal">(dejar vacío para no cambiar)</span></label>
                                    <input
                                        type="password"
                                        value={data.password}
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-500">Acceso limitado con permisos configurables.</p>
                                </button>
                            </div>
                        </div>
                        ...
                        {!esAdmin && (
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                                ...
                                <p className="text-sm text-gray-500 mb-6 ml-10">Configura qué secciones puede acceder este empleado.</p>
                                ...
                                {data.permisos.length > 0 && (
                                    <div className="mt-4 p-3 bg-green-50 rounded-xl">
                                        <p className="text-sm text-green-700 font-medium">
                                            ✓ {data.permisos.length} permiso(s) activo(s)
                                        </p>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-sm text-red-700">
                                        <strong>Administrador:</strong> Acceso total a todas las secciones del sistema.
                                    </p>
                                </div>
                            </div>
                        )}
