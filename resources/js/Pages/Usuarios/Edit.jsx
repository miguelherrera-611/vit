                        ...
                        {!esAdmin && (
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                                ...
                                <p className="text-sm text-gray-500 mb-6 ml-10">
                                    Configura qué secciones puede acceder este empleado.
                                    El botón <strong className="text-emerald-700">Predeterminados</strong> restaura los permisos esenciales de un vendedor.
                                </p>
