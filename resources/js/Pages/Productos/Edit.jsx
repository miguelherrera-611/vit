                ...
                <div className="bg-white border-b border-gray-200">
                    <div className="max-w-4xl mx-auto px-6 py-8">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-light text-gray-900">Editar Producto</h1>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                min="0"
                                            />
                                            <p className="mt-1 text-xs text-gray-400">Para ajustar stock usa el módulo de Inventario</p>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white rounded-2xl shadow-sm p-6">
                                    ...
                                    {producto.imagen && !data.imagen && (
                                        <div className="mb-4">
                                            <img src={`/storage/${producto.imagen}`} alt="Imagen actual" className="w-full h-40 object-cover rounded-xl" />
                                            <p className="text-xs text-gray-400 mt-2 text-center">Imagen actual</p>
                                        </div>
                                    )}
                                    <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center hover:border-blue-400 transition">
                                        {data.imagen ? (
                                            <div>
                                                <img src={URL.createObjectURL(data.imagen)} alt="Preview" className="w-full h-32 object-cover rounded-lg mb-3" />
                                            ...
                                            <label className="cursor-pointer">
                                                <p className="text-sm text-gray-500 mb-1">Cambiar imagen</p>
