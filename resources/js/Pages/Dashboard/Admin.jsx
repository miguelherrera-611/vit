    ...
    return (
        <AppLayout>
            <style>{`
                ...
                /* floating bg deco shapes — water drops on warm bg */
                .bg-deco {
                    position: absolute;
                    pointer-events: none;
                    ...
                    box-shadow:
                        0 8px 32px rgba(200,100,30,0.06),
                ...
                .glass-header {
                    ...
                    box-shadow:
                        0 4px 24px rgba(200,100,30,0.07),
                ...
                /* top-left refraction — like a real water drop */
                .glass-card::after {
                    content: '';
                    position: absolute;
                ...
                .glass-card:hover {
                    ...
                    box-shadow:
                        0 24px 64px rgba(180,90,20,0.13),
                        0 6px 20px rgba(180,90,20,0.07),
                        inset 0 1.5px 0 rgba(255,255,255,0.95),
                        inset 0 -1px 0 rgba(180,90,20,0.05),
                ...
                .glass-action-btn {
                    ...
                    border: 1px solid rgba(255,255,255,0.65);
                    box-shadow:
                        0 2px 10px rgba(180,90,20,0.08),
                        inset 0 1px 0 rgba(255,255,255,0.82),
                        inset 0 -1px 0 rgba(180,90,20,0.04);
                ...
                .glass-action-btn:hover {
                    ...
                    border-color: rgba(255,255,255,0.82);
                    box-shadow:
                        0 4px 16px rgba(180,90,20,0.1),
                        inset 0 1px 0 rgba(255,255,255,0.9),
                        inset 0 -1px 0 rgba(180,90,20,0.05);
                    transform: translateY(-1px);
                    color: rgba(100,45,5,0.95);
                }
                ...
                <div className="admin-content">
                        ...
                        <div style={{ maxWidth:'1280px', margin:'0 auto', padding:'1.5rem' }}>
                            <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
                                ...
                                <div style={{
                                    ...
                                    color:'rgba(190,80,10,0.85)',
                                    boxShadow:'0 2px 8px rgba(180,90,20,0.08), inset 0 1px 0 rgba(255,255,255,0.8)',
                    ...
                    <div style={{ maxWidth:'1280px', margin:'0 auto', padding:'2.5rem 1.5rem' }}>
                        ...
                        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(200px, 1fr))', gap:'1.25rem', marginBottom:'2.5rem' }}>
                            <div className="anim-1"><StatsCard icon="box"   value="0"  label="Productos Activos" accent="rgba(59,130,246,0.8)"  accentBg="rgba(59,130,246,0.07)"  /></div>
                            <div className="anim-2"><StatsCard icon="cart"  value="0"  label="Ventas del Día"    accent="rgba(16,185,129,0.8)"  accentBg="rgba(16,185,129,0.07)"  /></div>
                            <div className="anim-3"><StatsCard icon="alert" value="0"  label="Stock Bajo"        accent="rgba(245,158,11,0.85)" accentBg="rgba(245,158,11,0.07)"  /></div>
                            <div className="anim-4"><StatsCard icon="money" value="$0" label="Ventas del Mes"    accent="rgba(220,38,38,0.8)"   accentBg="rgba(220,38,38,0.07)"   /></div>
                        </div>
