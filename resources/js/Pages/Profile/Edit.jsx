...
const STYLES = `
    ...
    *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
    ...
    .alert-warning { padding:0.65rem 1rem; border-radius:12px; font-size:0.8rem; margin-bottom:1rem; background:rgba(245,158,11,0.08); border:1px solid rgba(245,158,11,0.25); color:rgba(146,64,14,0.85); }
