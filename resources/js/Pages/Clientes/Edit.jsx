                ...
                <div className="cl-header">
                    <div className="cl-shell" style={{paddingBottom:'1rem'}}>
                        <div style={{display:'flex',alignItems:'center',gap:'0.75rem'}}>
                            ...
                            <div>
                                <h1 style={{fontSize:'clamp(1.35rem,3vw,1.9rem)',fontWeight:'300',color:'#2d1a08'}}>Editar Cliente</h1>
                                <p style={{fontSize:'0.82rem',color:'rgba(120,60,10,.58)'}}>{cliente.nombre}</p>
                            </div>
                        </div>
                    </div>
                </div>
