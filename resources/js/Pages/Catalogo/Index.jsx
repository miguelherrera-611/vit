        ...
        <ClienteLayout>
            ...
            <style>{`
                ...
                .glass-btn-catalogo {
                    ...
                    border: 1px solid rgba(255,255,255,0.65);
                    color: rgba(120,60,10,0.85); text-decoration: none;
                    transition: all 0.2s ease;
                    box-shadow: inset 0 1px 0 rgba(255,255,255,0.8);
                }
                .glass-btn-catalogo:hover {
            ...
            <div className="cat-hero">
                ...
                <p style={{fontSize:'0.72rem',fontWeight:'700',color:'rgba(150,80,20,0.55)',letterSpacing:'0.14em',textTransform:'uppercase',marginBottom:'0.75rem'}}>
                    Colección
                </p>
                                    ...
                                    <Link href={`/catalogo/${grupo.id}`} className="grupo-card">
                                        ...
                                        <div style={{overflow:'hidden',position:'relative'}}>
                                            {grupo.imagen ? (
                                                ...
                                                <div className="grupo-img-placeholder" style={{background:colors.bg}}>
                                                    🛍️
                                                </div>
                                            )}
                                            {/* Badge de productos */}
                                        ...
                                        <div style={{padding:'1.5rem'}}>
                                            <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',marginBottom:'0.75rem'}}>
                                                <div>
                                                    ...
                                                    {grupo.descripcion && (
                                                        <p style={{fontSize:'0.82rem',color:'rgba(150,80,20,0.6)',lineHeight:'1.5'}}>
                                                            {grupo.descripcion}
                                                        </p>
                                                    )}
                                                </div>
                                            ...
                                            <div style={{
                                                ...
                                                paddingTop:'1rem',borderTop:'1px solid rgba(200,140,80,0.12)',
                                            }}>
                                                ...
                                                <span style={{
                                                    ...
                                                    color:colors.text,display:'flex',alignItems:'center',gap:'0.3rem',
                                                }}>
                                                    Ver colección
