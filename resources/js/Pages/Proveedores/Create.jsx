                ...
                <div className="bg-white border-b border-gray-200">
                    <div className="max-w-3xl mx-auto px-6 py-8">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-light text-gray-900">Nuevo Proveedor</h1>
                                <p className="mt-1 text-sm text-gray-500">Registra la información del proveedor</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">El proveedor estará disponible para asociar con productos</p>
                                    </div>
